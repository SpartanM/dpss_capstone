---
title: "Hate Crime in the United States"
author: "Yaoli Ma"
date: "7/16/2019"
output: pdf_document
indent: true
...
Hate crime, according to FBI, is a “criminal offense against a person or property motivated in whole or in part by an offender’s bias against a race, religion, disability, sexual orientation, ethnicity, gender, or gender identity.” This policy memo aims to examine the nature and recent developments of hate crimes in the U.S. using data drawn from four sources. The hate crime data for the years 2008 - 2017 comes from FBI’s Uniform Crime Reports (UCR). Participation in the UCR Program is mandated for federal law enforcement agencies, but is voluntary for their local, state, and tribal counterparts. For example, the state of Hawaii does not report any data to UCR. Therefore, the difference in the likelihood of different non-federal law enforcement agencies to report hate crimes to UCR may cause potential biases. In addition, nine state-level socioeconomic factors, including median household income, percentage of population unemployed, percentage of population with only high school degree, percentage of white population below poverty line, GINI index, percentage of non-white population, percentage of non-citizen population, percentage of LGBT population, and percentage of Muslim population, are collected from Census Bureau’s American Community Survey (ACS), Kaiser Family Foundation and Gallup’s U.S. daily tracking survey.
...
In order to assess whether the socioeconomic indicators exert significant influences on the hate crime rates across the country, this policy memo applies multivariate linear regression models with time fixed effects to panel data composed of hate crime rates and aforementioned socioeconomic factors for 49 states (excluding Hawaii) during the years 2012 - 2016. This approach allows the estimation of the independent impact that each variable have while controlling for nationwide shocks such as the 2016 Presidential Election. An additional independent variable, the percentage of population covered by law enforcement agencies reporting to the Hate Crime Statistics Program, is included in the model to control for the potential differences in the probability of hate crimes being reported in each state. 
...
The results of the multivariate liner regressions are shown in Table 1. Model 1 presents the effects of each of the indicators on hate crime rates, excluding moderating and nonlinear effects. In this model, the first seven variables have significant effects on the hate crime rates. By contrast, the percentage of LGBT population and that of Muslim population is not strongly related to hate crime rates. Model 2, incorporating squared terms for each of the nine socioeconomic indicators, suggests that the percentage of population unemployed, the percentage of non-white population, the percentage of non-citizen population, and the percentage of LGBT population have nonlinear effects on hate crime rates. Model 3 adds interaction terms for unemployed population and non-citizen population, white population in poverty and non-white population, respectively. Those interaction terms are designed to determine whether the effects of immigration and racial diversity are moderated by economic factors. The results provide no support for such hypothesis.
...
ggplot() +
  ...
  labs(title="Figure 3: U.S. Hate Crime Rates and LGBT Population (2012 - 2016)",
       ...
       y = "Avg. Annual Hate Crimes per 100k pop.",
       x = "Pct. of LGBT pop.") +
  annotate("text", x=0.085, y=13, label = "District of Columbia", color="red") +
  theme_bw()
```

Given the fact that the percent of LGBT population is not statistically significant in model 1 but highly significant in models 2 and 3, this policy memo provides further analysis of its relationship with hate crime rates. Figure 3 includes data points for 49 states as well as D.C. It is evident that D.C. is an extreme outlier in terms of both LGBT population and hate crime rates. The introduction of a nonlinear trend line using a quadratic function indicates that, with the increase of the percentage of LGBT population, hate crime rates first decrease and then increase. It remains to be seen, though, whether this interesting finding can be backed up by some theories regarding its causal mechanism.