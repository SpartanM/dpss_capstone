...
model_agg2 <- plm(avg_hate_crime ~ med_income + pct_unemployed + 
                    pct_HSdegree + pct_HSdegree_square +
              pct_white_poverty + pct_non_white + 
                gini_index +
                pct_non_citizen +
              pct_lgbt + pct_lgbt_square + pct_muslim + pct_pop_covered, 
              data = data_agg, 
              index = c("NAME", "year"), model = "within", effect = "twoways")

model_agg3 <- plm(avg_hate_crime ~ med_income +
...
stargazer(model_agg1, model_agg2, model_agg3, type='latex', title = "Regression Results",
          ...
          covariate.labels = c("Median Income", "Pct. Unemployed", "Pct. Only HS degree", 
              "Pct. Only HS degree$^{2}$", "Pct. White below poverty line", "Pct. Non-white",
              "GINI index", "Pct. Non-citizen", "Pct. LGBT", "Pct. LGBT$^{2}$",
              "Pct. Muslim", "Pct. Pop. Covered", 
